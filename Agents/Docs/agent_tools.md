# 🔍 Information Retrieval | Database & Data Management Tools >
    ...
    - File/document | Content & Media:
      - Read/write files (local filesystem, cloud storage).
      - CSV/Excel Processing: Parse and manipulate spreadsheets.
      - Format conversions, compression.
      - Summarize or extract structured data from PDFs, DOCX, Excel, etc.
...
# ⚙️ System & Developer Utilities >
    ...
    - Math/logic tools → calculators, symbolic math (SymPy), equation solvers, unit converters.
    - Regex/string parsers for structured data extraction.

## Misc: Agent Control / Meta
    - Memory tools: Store & recall structured memory of the conversation; Persist agent state across sessions.
    - Workflow orchestration: Call other LangGraph subgraphs.
    - Workflow Triggers: Webhook handlers
    - Task Scheduling: Cron-like scheduling
    - Notification Systems: Send alerts, updates
    - Logging/Tracing: for debugging & observability.